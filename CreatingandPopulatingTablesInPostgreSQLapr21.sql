--this makes a database called apr2021allportals
CREATE DATABASE apr2021allportals;

--this command connects to the database called apr2021allportals
\c apr2021allportals;
...
COPY BRD FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\brd.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

--make sure userIDs say obsr123 not user123 (they are listed as obsr in the EBD but user on some back-end exports)
COPY USR FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\usr.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

COPY LOC FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\loc.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

--optional block name table
COPY BNM FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\bnm.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

COPY SUB FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\sub.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

--will have to process R script (Shiny folder) before you can add URL
COPY URL FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\url.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

--obs is the largest table so this next line can take quite a while to load if the file is large               
COPY OBS FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\obs.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';

--optional nocturnal tag
--COPY NOC FROM 'C:\Users\nicho\Desktop\Dec2020downloadplusdatabase\noc.csv' DELIMITER ',' CSV HEADER NULL AS 'NA';
